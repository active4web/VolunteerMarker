...
<li>
						...
						<li>
							<span class="active">الأقليم</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الأقليم</span>
									</div>
								</div>
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة اقليم
									...
									<form action="<?=$url?>admin/places/region_delete" method="POST" id="form">
									<div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
											...
											$country_name=get_table_filed("city",array("id"=>$country_id),"name");
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/places/region_details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/places/region_delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/add_region");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/delete_region");
	});
});
</script>
...
//alert(id);
			$.ajax({
				url: '<?php echo base_url("admin/places/check_view_region") ?>',
                type: 'POST',
                data: data,				
