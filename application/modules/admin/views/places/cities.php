						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة مدينة
									...
									<form action="<?=$url?>admin/places/city_delete" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/places/city_details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/places/city_delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/add_city");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/places/delete_city");
	});
});
</script>
...
//alert(id);
			$.ajax({
				url: '<?php echo base_url("admin/places/check_view_city") ?>',
                type: 'POST',
                data: data,				
