							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الأخبار </span>
									</div>
								...
								<span class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										switch($view){
													...
													$image=$data->img;
												$img=$url."uploads/products/".$image; 
												?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td> <?=mb_substr($data->title,0,50);?> </td>
												<td> <?=mb_substr($data->title_en,0,50);?> </td>
							<td><a title="view image" class="example-image-link" href="<?php echo $img;?>" data-lightbox="example-1">مشاهدة</a></td>

                                                 <td> <?=mb_substr($data->source,0,50);?> </td>
													<td> 
