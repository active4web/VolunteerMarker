			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<div class="row">
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block" style="direction:ltr;text-align:left">Title</span>
																			<input name="title_en" id="title_en" value="<?= $data->title_en?>"  style="direction:ltr;text-align:left" type="text" placeholder="Title" class="form-control" required>
																		</div>
																	</div>	
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">المصدر</span>
																			<input name="source" id="source" value="<?= $data->source?>"  type="text" placeholder="المصدر" class="form-control" required>
																		</div>
																	</div>	
																	...
																	<div class="form-group">
																		...
																		<span class="help-block" style="direction:ltr;text-align:left">Source</span>
																			<input name="source_en"  value="<?= $data->source_en?>"  style="direction:ltr;" id="source_en" type="text" placeholder="Source" class="form-control" required>
																		</div>
																	</div>	
																	...
																	<textarea name="institute_about" id="institute_about" class="form-control" style="height:100px;"><?= $data->institute_about?></textarea>
						...
						<textarea name="institute_about_en" id="institute_about_en" class="form-control" style="height:100px;direction:ltr;text-align:left"> <?= $data->institute_about_en?></textarea>
																		</div>
																	</div>
																	...
																	<div class="form-group outside_courses">
																		...
																		<span class="help-block">رابط الخبر</span>
																			<input name="link" id="link"  value="<?= $data->link?>"  type="text" placeholder="رابط الخبر" class="form-control" required>
																		</div>
																	</div>
