			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">طلبات المساعدة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">طلبات المساعدة</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/users/delete" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										$conutry_id=$data->conutry_id;

										$city_name=get_table_filed('city',array('id'=>$city_id),"name");
									$country_name=	get_table_filed('country',array('id'=>$conutry_id),"title");
									$region_name=	get_table_filed('region',array('id'=>$region_id),"name");
										$view=$data->view;
										switch($view){
													case 0:
                                        ...
                                        ?>
											<tr class="odd gradeX">
												...
												<td> <?=mb_substr($data->name,0,40);?> </td>
													<td> <?= $data->email;?> </td>
												<td> <?=$data->phone;?> </td>
												<td> <?= mb_substr($country_name,0,40);?> </td>
												<td> <?=  mb_substr($city_name,0,40);?> </td>
												<td> <?= mb_substr($region_name,0,40);?> </td>
												<td> <?= mb_substr($data->help,0,40);?> </td>
												<td> <?= mb_substr($data->foundation,0,40);?> </td>
											<td> 
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?=$url?>admin/users/delete?id_customers=<?= $data->id?>"><i class="fa fa-remove"></i> حذف </a>
													   </li>
														</ul>
													</div>
												</td>
