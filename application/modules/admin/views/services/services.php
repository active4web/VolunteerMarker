...
<li>
						...
						<li>
							<span class="active">مجالات التطوع</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">مجالات التطوع</span>
									</div>
								</div>
									...
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												...
												<?php 
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة خدمة
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/services/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/services/delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
