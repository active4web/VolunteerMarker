...
<li>
						...
						<li>
							<span class="active">نوع المساعدة</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">نوع المساعدة</span>
									</div>
								</div>
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												...
												<?php 
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة نوع المساعدة
									...
									<form action="<?=$url?>admin/services/delete_help" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/services/details_help?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/services/delete_help?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/services/add_help");
    });
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/services/check_view_help") ?>',
                type: 'POST',
                data: data,				
