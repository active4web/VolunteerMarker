			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/services/';?>">مجالات التطوع</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span> تصنيف</span>
															 ...
															 <input name="id" value="<?=$services_type->id;?>" type="hidden">
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																		<span class="help-block"> عنوان التصنيف </span>
																			<input name="title" id="title" value="<?=$services_type->name;?>" type="text" placeholder="عنوان التصنيف" class="form-control" required>
