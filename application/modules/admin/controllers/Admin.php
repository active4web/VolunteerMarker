...
$data = array('linkedin'=>$linkedin,'name_en'=>$site_name_en,'name'=>$site_name,'facebook'=>$facebook,'twitter'=>$twitter,'instagram'=>$instagram,'keywords'=>$key_words,'description'=>$meta_desc);
