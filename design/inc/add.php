...
var source_en=$("#source_en").val();
var institute_about=$("#institute_about").val();
var institute_about_en=$("#institute_about_en").val();
var link=$("#link").val();
var service_type=$("#service_type").val();
  if(title==""){
      toastr.error("من فضلك حدد عنوان الخبر"); 
    $(".mainbutton").prop('disabled', false);
  }
if(title_en==""){
    toastr.error("من فضلك حدد العنوان بالأنجليزى"); 
    $(".mainbutton").prop('disabled', false);
}
if(source==0){
    toastr.error("من فضلك حدد مصدر الخبر"); 
    $(".mainbutton").prop('disabled', false);
}
if(source_en==""){
    toastr.error("من فضلك حدد المصدر بالأنجليزى"); 
    $(".mainbutton").prop('disabled', false);
}

if(institute_about==""){
    toastr.error("من فضلك حدد وصف الخبر"); 
    $(".mainbutton").prop('disabled', false);
}
if(institute_about_en==""){
    toastr.error("من فضلك حدد الوصف بالأنجليزى"); 
    $(".mainbutton").prop('disabled', false);
}
if(link==""){
    toastr.error("من فضلك حدد رابط الخبر"); 
    $(".mainbutton").prop('disabled', false);
}
...
if(title!=""&&link!=0&&institute_about_en!=""&&institute_about!=""&&source_en!=""&&source!=""&&title_en!=""){
$.ajax({
        type:"POST",
        enctype: 'multipart/form-data',
        url:url,
